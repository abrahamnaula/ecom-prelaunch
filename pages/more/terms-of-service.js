            ...
            <div className="bg-bebe text-black text-transform: uppercase min-h-screen flex flex-col items-center">
                <div className="flex justify-center flex-col items-center font-nhg text-xxs sm:text-sm font-medium flex-1">
                    ...
                    <div className="w-2/3 flex-1 pb-8">
                        <h2 className="font-bold underline">TERMS OF SERVICE:</h2>
                        <p className="py-4">OVERVIEW</p>
                        <p>
                            This website is operated by Gray Era. Throughout the site, the terms “we”, “us” and “our” refer to Gray Era. Gray Era offers this website, including all information, tools and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
                        </p>
                        ...
                        <h3 className="font-bold mt-4">SECTION 1 - ONLINE STORE TERMS</h3>
                        <div className="h-4"></div>
                        ...
                        <h3 className="font-bold mt-4">SECTION 2 - GENERAL CONDITIONS</h3>
                        <div className="h-4"></div>
                        ...
                        <h3 className="font-bold mt-4">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h3>
                        <div className="h-4"></div>
                        ...
                        <h3 className="font-bold mt-4 mb-4">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h3>
                        <p>
                        ...
                        <h3 className="font-bold mt-4 mb-4">SECTION 5 - PRODUCTS OR SERVICES (if applicable)</h3>
                        <p>
                        ...
                        <h3 className="font-bold mt-4 mb-4">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h3>
                        <p>
                        ...
                        <h3 className="font-bold mt-4">SECTION 7 - OPTIONAL TOOLS</h3>
                        <div className="h-4"></div>
                        ...
                        <h3 className="font-bold mt-4">SECTION 8 - THIRD-PARTY LINKS</h3>
                        <div className="h-4"></div>
                        ...
                        <h3 className="font-bold mt-4">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h3>
                        <div className="h-4"></div>
                        ...
                        <h3 className="font-bold underline mt-4">SECTION 10 - PERSONAL INFORMATION</h3>
                        <div className="h-4"></div>
                        ...
                        <div className="font-bold underline">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</div>
                        <div className="mt-4">
                        ...
                        <div className="font-bold underline mt-8">SECTION 12 - PROHIBITED USES</div>
                        <div className="mt-4">
                        ...
                        <div className="font-bold underline mt-8">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</div>
                        <div className="mt-4">
                        ...
                        <div className="mt-4">
                            In no case shall Gray Era, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility.
                        </div>
                        <div className="mt-4">
                            Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.
                        </div>

                        <div className="font-bold underline mt-8">SECTION 14 - INDEMNIFICATION</div>
                        <div className="mt-4">
                            You agree to indemnify, defend and hold harmless Gray Era and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
                        </div>

                        <div className="font-bold underline mt-8">SECTION 15 - SEVERABILITY</div>
                        <div className="mt-4">
                            In the event that any provision of these Terms of Service is determined to be unlawful, void or unenforceable, such provision shall nonetheless be enforceable to the fullest extent permitted by applicable law, and the unenforceable portion shall be deemed to be severed from these Terms of Service, such determination shall not affect the validity and enforceability of any other remaining provisions.
                        </div>

                        <div className="font-bold underline mt-8">SECTION 16 - TERMINATION</div>
                        <div className="mt-4">
                        ...
                        <div className="font-bold underline mt-8">SECTION 17 - ENTIRE AGREEMENT</div>
                        <div className="mt-4">
                        ...
                        <div className="font-bold underline mt-8">SECTION 18 - GOVERNING LAW</div>
                        <div className="mt-4">
                            These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of United States.
                        </div>

                        <div className="font-bold underline mt-8">SECTION 19 - CHANGES TO TERMS OF SERVICE</div>
                        <div className="mt-4">
                        ...
                        <div className="font-bold underline mt-8">SECTION 20 - CONTACT INFORMATION</div>
                        <div className="mt-4">
