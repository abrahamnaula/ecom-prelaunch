            ...
            <div className="bg-grayMo min-h-screen flex flex-col items-center">
                <div className="flex justify-center flex-col items-center font-nhg text-xxs sm:text-sm font-medium flex-1">
                    ...
                    <div className="w-2/3 flex-1 pb-8">
                        ...
                        <h3 className="font-bold mt-4">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h3>
                        <p>
                        ...
                        <h3 className="font-bold mt-4">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h3>
                        <p>
                        ...
                        <h3 className="font-bold mt-4">SECTION 10 - PERSONAL INFORMATION</h3>
                        <p>
